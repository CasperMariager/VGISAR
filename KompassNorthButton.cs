...
public class Kompass : MonoBehaviour {
	...
	void Start()
    {
        ...
        rotateButton.onClick.AddListener(TaskOnClick);
    }

    void TaskOnClick()
    {
        //Output this to console when Button1 or Button3 is clicked
		float correction = Input.compass.magneticHeading;
		
		transform.rotation = Quaternion.Euler(0, -correction, 0);

		insect = "You rotated towards north by:" + correction;
    }
